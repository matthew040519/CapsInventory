      ...
      <div class="content">
        <div class="row gy-3 mb-6 justify-content-between">
          <div class="col-md-9 col-auto">
            <h2 class="mb-2 text-body-emphasis">Inventory Report</h2>
            <p class="text-body-tertiary fw-semibold">
              The inventory report provides a comprehensive overview of the products available in stock, their quantities, and their respective values. This report is essential for effective inventory management, helping you track stock levels, identify fast-moving items, and make informed purchasing decisions.
            </p>
          </div>
        </div>
        <?php
