      ...
      <div class="content">
        <div class="row gy-3 mb-6 justify-content-between">
          <div class="col-md-9 col-auto">
            <h2 class="mb-2 text-body-emphasis">Suppliers</h2>
            <p class="text-body-tertiary fw-semibold">
              Suppliers are individuals or entities that provide goods or services to your business. Each supplier can have attributes such as name, contact information, and supply history. Organizing your supplier data allows for efficient management, communication, and reporting, making it easier for users to find and manage specific supplier information.
            </p>
          </div>
        </div>
        <?php
        ...
        <div class="modal fade" id="addProductModal" tabindex="-1" aria-labelledby="productModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <form action="../include/supplier.php" enctype="multipart/form-data" method="POST">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea name="supplier_address" class="form-control" id="supplier_address" cols="6" rows="6" required></textarea>
                                            </div>
                                        </div>
                          ...
                          <table class="table table-striped table-sm fs-9 mb-0">    
                            <thead>
                              <tr>
                                ...
                                <th class="sort border-top" data-sort="supplier_name">Supplier</th>
                                <th class="sort border-top" data-sort="supplier_address">Address</th>
                            ...
                            <tbody class="list">
                              ...
                              <tr>
                                <td class="align-middle ps-3 id"><?php echo $supplier['id']; ?></td>
                                <td class="align-middle supplier_name"><?php echo $supplier['supplier_name']; ?></td>
                                <td class="align-middle supplier_address"><?php echo $supplier['supplier_address']; ?></td>
                              </tr>
                            <?php } ?>
                            </tbody>
                          </table>
