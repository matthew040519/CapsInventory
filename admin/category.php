      ...
      <div class="content">
        <div class="row gy-3 mb-6 justify-content-between">
          <div class="col-md-9 col-auto">
            <h2 class="mb-2 text-body-emphasis">Category</h2>
            <p class="text-body-tertiary fw-semibold">
              Categories help organize your products into logical groups, making it easier to manage inventory and for users to browse related items. Use categories to classify products by type, brand, or any other relevant attribute.
            </p>
          </div>
        </div>
        <?php
        ...
        <div class="modal fade" id="addCategoryModal" tabindex="-1" aria-labelledby="categoryModalLabel" aria-hidden="true">
         ...
         <div class="p-4 code-to-copy">
                      <div id="tableExample3" data-list='{"valueNames":["id","category_name"],"page":10,"pagination":true}'>
                          ...
                          <table class="table table-striped table-sm fs-9 mb-0">
                            <thead>
                              <tr>
                                ...
                                <th class="sort border-top" data-sort="category_name">Category Name</th>
